...
local animNames = { 
	idle = 	{	
				{ id = "http://www.roblox.com/asset/?id=2510197257", weight = 1 },
				{ id = "http://www.roblox.com/asset/?id=2510197257", weight = 1 },
				{ id = "http://www.roblox.com/asset/?id=2510197257", weight = 9 }
			},
	walk = 	{ 	
				{ id = "http://www.roblox.com/asset/?id=4646819185", weight = 10 } 
			}, 
	run = 	{
				{ id = "http://www.roblox.com/asset/?id=04656885777", weight = 10 } 
			}, 
	swim = 	{
...
function setRunSpeed(speed)
	...
	if runSpeed ~= currentAnimSpeed then
		if runSpeed < 0.75 then
			currentAnimTrack:AdjustWeight(1.0)		
			runAnimTrack:AdjustWeight(smallButNotZero)
		elseif runSpeed < 0.8 then
